"""
Problem 3 Use Case 1 PolyTaylor Method
This script creates a Taylor polynomial surrogate model for the aircraft design problem and optimizes it using a surrogate-based approach.
"""
#%% 
